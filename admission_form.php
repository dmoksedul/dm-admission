                ...
                <div>
                    ...
                    <div class="student_details_form input_main_box">
                        ...
                        <div class="input_box">
                            ...
                            <select name="student_blood_group" id="" required placeholder="Select">
                                <option>Select</option>
                        ...
                        <div class="input_box">
                            ...
                            <div class="custom-file-input">
                                <label for="student_documents" class="custom-file-label">Choose file...</label>
                    ...
                    <div class="input_main_box">
                        ...
                        <div class="input_box">
                            ...
                            <div class="custom-file-input">
                                <label for="student_parent_image" class="custom-file-label">Choose file...</label>
                                <input style="width:100%;" type="file" name="student_parent_image" id="file-input" accept="image/*" class="hidden" required/>
                                <button type="button" id="browse-button" class="custom-browse-button">Browse</button>
                            </div>
                        </div>
                    </div>
